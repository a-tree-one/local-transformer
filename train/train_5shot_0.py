...
parser.add_argument('--experiment_dir', default='/media/yyw/JX_disk/yyw_disk/yyw/pycharm_pro/2019late/'
                                                'Local-Transformer/'
                                                'experiment/Model_5shot_0')
parser.add_argument('--model_dir', default='/media/yyw/JX_disk/yyw_disk/yyw/pycharm_pro/2019late/'
                                           'Local-Transformer/'
                                           'experiment/Model_5shot_0/model_save')
...
def get_dataloader_few_shot():
    ...
    val_loader = torch.utils.data.DataLoader(
        MyDataset_val(test_group=0, k_shot=5),
