...
def read_mask(mask_path):
    ...
    return np.array(m_uint, dtype=np.int64)
...
class PASCAL:
    ...
    def create_anns(self, read_mode):
        if self.db_path.endswith('pascal'):
            segmentation_sub_file = 'SegmentationClass'
            instance_sub_file = 'SegmentationObject'
        ...
        for item in names:
            ...
            mobj_path = osp.join(self.db_path, instance_sub_file, item + '.png')
